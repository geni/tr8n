...
class Tr8n::Translator < ApplicationRecord
  ...
  has_many  :translator_logs,               :dependent => :destroy, :order => "created_at desc"
  has_many  :translator_following,          :dependent => :destroy, :order => "created_at desc"
  ...
  belongs_to :fallback_language, :class_name => 'Tr8n::Language'
