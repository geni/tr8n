...
class MethodTokenTest < Tr8n::TestCase
  ...
  test 'registering incorrect tokens' do
    [
      ...
      assert_equal 0, Tr8n::Tokens::MethodToken.parse(label).count
    end
  end
  ...
  test 'registering correct tokens' do
    [
      ...
      assert_equal Tr8n::Tokens::MethodToken.name, tokens.first.class.name
    end
