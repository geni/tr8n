Tr8n::Engine.routes.draw do
  ...
  post '/phrases/delete_comment',  :to => 'phrases#delete_comment'
  get  '/phrases/dictionary',      :to => 'phrases#dictionary'
  get  '/phrases/lb_sources',      :to => 'phrases#lb_sources'
  get  '/phrases/map',             :to => 'phrases#map'
  post '/phrases/submit_comment',  :to => 'phrases#submit_comment'
  post '/phrases/translate',       :to => 'phrases#translate'
  post '/phrases/update',          :to => 'phrases#update'
  get  '/phrases/view',            :to => 'phrases#view'
  post '/phrases/vote',            :to => 'phrases#vote'
